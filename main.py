...
class BaseFlaskApp:
    ...
    @property
    def app(self):
        """Encapsulation: Protected app access"""
        return self._app

    @property
    def db(self):
        """Encapsulation: Protected db access"""
        return self._db

    @property
    def mail(self):
        """Encapsulation: Protected mail access"""
        return self._mail

    def render_page(self, template, **kwargs):
        """Polymorphism: Overridable render method"""
...
class DentalClinicApp(BaseFlaskApp):
    ...
    def _register_routes(self):
        ...
        self.app.route("/webhook/paymongo")(self.paymongo_webhook)
        self.app.route("/create_gcash_payment")(self.create_gcash_payment)
        self.app.route("/")(self.index)
        self.app.route("/google_index")(self.google_index)
        self.app.route("/login")(self.login_manual)
        self.app.route("/google-auth")(self.login_g_auth)
        self.app.route("/sign-up")(self.sign_up)
        self.app.route("/logout")(self.logout)
        self.app.route("/patient_forms")(self.p_forms)
        self.app.route("/about")(self.about_customer)
        self.app.route("/google_booked_customer")(self.google_bookedCustomer)
        self.app.route("/booked_customer")(self.bookedCustomer)
        self.app.route("/approve")(self.approve)
        ...
        self.app.route("/save_dental_record")(self.save_dental_record)
